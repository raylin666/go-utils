...
func (c *Client) ClientGetName() (string, error) {
	return c.Conn.ClientGetName(c.Context).Result()
}

func (c *Client) Echo(message interface{}) (string, error) {
	return c.Conn.Echo(c.Context, message).Result()
}
...
func (c *Client) Dump(key string) (string, error) {
	return c.Conn.Dump(c.Context, key).Result()
}

func (c *Client) Get(key string) (string, error) {
	return c.Conn.Get(c.Context, key).Result()
}
...
func (c *Client) GetRange(key string, start, end int64) (string, error) {
	return c.Conn.GetRange(c.Context, key, start, end).Result()
}

func (c *Client) GetSet(key string, value interface{}) (string, error) {
	return c.Conn.GetSet(c.Context, key, value).Result()
}

func (c *Client) GetEx(key string, expiration time.Duration) (string, error) {
	return c.Conn.GetEx(c.Context, key, expiration).Result()
}

func (c *Client) GetDel(key string) (string, error) {
	return c.Conn.GetDel(c.Context, key).Result()
}
...
func (c *Client) ObjectEncoding(key string) (string, error) {
	return c.Conn.ObjectEncoding(c.Context, key).Result()
}
...
func (c *Client) RandomKey() (string, error) {
	return c.Conn.RandomKey(c.Context).Result()
}
...
func (c *Client) HGet(key, field string) (string, error) {
	return c.Conn.HGet(c.Context, key, field).Result()
}
...
func (c *Client) BRPopLPush(source, destination string, timeout time.Duration) (string, error) {
	return c.Conn.BRPopLPush(c.Context, source, destination, timeout).Result()
}

func (c *Client) LIndex(key string, index int64) (string, error) {
	return c.Conn.LIndex(c.Context, key, index).Result()
}
...
func (c *Client) LPop(key string) (string, error) {
	return c.Conn.LPop(c.Context, key).Result()
}
...
func (c *Client) RPop(key string) (string, error) {
	return c.Conn.RPop(c.Context, key).Result()
}
...
func (c *Client) RPopLPush(source, destination string) (string, error) {
	return c.Conn.RPopLPush(c.Context, source, destination).Result()
}
...
func (c *Client) LMove(source, destination, srcpos, destpos string) (string, error) {
	return c.Conn.LMove(c.Context, source, destination, srcpos, destpos).Result()
}

func (c *Client) BLMove(source, destination, srcpos, destpos string, timeout time.Duration) (string, error) {
	return c.Conn.BLMove(c.Context, source, destination, srcpos, destpos, timeout).Result()
}
...
func (c *Client) SPop(key string) (string, error) {
	return c.Conn.SPop(c.Context, key).Result()
}
...
func (c *Client) SRandMember(key string) (string, error) {
	return c.Conn.SRandMember(c.Context, key).Result()
}
...
func (c *Client) ClientList() (string, error) {
	return c.Conn.ClientList(c.Context).Result()
}
...
func (c *Client) Info(section ...string) (string, error) {
	return c.Conn.Info(c.Context, section...).Result()
}
...
func (c *Client) DebugObject(key string) (string, error) {
	return c.Conn.DebugObject(c.Context, key).Result()
}
...
func (c *Client) Eval(script string, keys []string, args ...interface{}) (interface{}, error) {
	return c.Conn.Eval(c.Context, script, keys, args...).Result()
}

func (c *Client) EvalSha(sha1 string, keys []string, args ...interface{}) (interface{}, error) {
	return c.Conn.EvalSha(c.Context, sha1, keys, args...).Result()
}
...
func (c *Client) ScriptLoad(script string) (string, error) {
	return c.Conn.ScriptLoad(c.Context, script).Result()
}
...
func (c *Client) ClusterNodes() (string, error) {
	return c.Conn.ClusterNodes(c.Context).Result()
}
...
func (c *Client) ClusterInfo() (string, error) {
	return c.Conn.ClusterInfo(c.Context).Result()
}
